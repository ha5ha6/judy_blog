...
**leetcode 31 - Next Permutation [M] - array** see [array #permutation](/programming/2019/10/29/data-structrue-array.html#permutation)    
**leetcode 46 - Permutations [M] - backtracking**   
**leetcode 47 - Permutations II [M] - backtracking** see [backtracking #permutation](/programming/2019/11/13/algorithm-backtracking.html#permutations)   
**leetcode 60 - Permutation Sequence [M] - math** see [math #permutation]()   
**leetcode 266 - Palindrome Permutation [E] - hash** see [string #palindrome](/programming/2019/10/26/data-structrue-string.html#palindrome)   
**leetcode 267 - Palindrome Permutation II [M] - backtracking** see [backtracking #palindrome](/programming/2019/11/13/algorithm-backtracking.html#palindrome)  
...
**leetcode 215 - Kth Largest in an Array [M] - min heap** see [heap #problems](/programming/2019/11/30/data-structrue-heap.html#problems)  
**leetcode 218 - The Skyline Problem [H] - priority queue, min heap** see [priority queue #problems](/programming/2019/12/02/data-structrue-priorityqueue.html#problems)  
**leetcode 252 - Meeting Rooms [E]** see [sorting #problems](programming/2019/11/14/algorithm-sorting.html#problems)  
**leetcode 253 - Meeting Rooms II - min heap[M]** see [heap #problems](/programming/2019/11/30/data-structrue-heap.html#problems)  
**leetcode 274 - H-index [M] - bucket sort** see [sorting #problems](/programming/2019/11/14/algorithm-sorting.html#problems)    
**leetcode 275 - H-index II (given sorted) [M] - binary search** see [binary search #h-index](/programming/2019/11/13/algorithm-binarysearch.html#h-index)
...
**leedcode 260 - Single Number III - xor[M]**  see [bit Manipulation # cancel out](/programming/2019/11/02/others-bit-manipulation.html#cancel-out)  

### Greedy  

see [greedy](/programming/2019/12/06/algorithm-greedy.html#array)  
...
**leetcode 227 - Basic Calculator II [M]**  see [stack #arithmetic](/programming/2019/11/13/data-structrue-stack.html#arithmetic-calculator)
**leetcode 282 - Expression Add Operators [H]** see [dfs]
...
**leetcode 220 - Contains Duplicate III [M] - hash**  see [hash #find dups](https://ha5ha6.github.io/judy_blog/programming/2019/11/14/data-structrue-hash.html#find-dups)  
**leetcode 287 - Find the Duplicate Number [M] - two pointers circle** see [array #find ele](/programming/2019/10/29/data-structrue-array.html#find-element)  
...
**leetcode 265 - Paint House [H] - dp,record 2 mins**  see [dp #paint colors](/programming/2019/10/23/algorithm-dp.html#paint-colors)

### Paint Fence  

**leetcode 276 - Paint House [E] - dp** see [dp #paint colors](/programming/2019/10/23/algorithm-dp.html#paint-colors)
